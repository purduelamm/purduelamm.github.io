...
## Digital Twin Development in Collaboration with Global Manufacturing Laboratories
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
    ...
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research(1).PNG?raw=true" style="max-width: 100%; height: auto; width: 500px; margin-right: 20px; object-fit: contain;" />
    </div>
  </div>
</div>
...
## Status Diagnosis of Battery Management System Using Sound Sensors
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research(2).PNG?raw=true"
...
## Digital Transformation of Legacy Industrial Models in the United States
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
    ...
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research(3).PNG?raw=true" 
      style="max-width: 100%; height: auto; width: 500px; margin-right: 20px; object-fit: contain;" />
    </div>
  </div>
</div>
...
## Multimodal Sensing for Welding Quality in Shipbuilding Robotic Systems
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research(4).PNG?raw=true"
           style="max-width: 100%; height: auto; width: 500px; margin-right: 20px; object-fit: contain;" />
    </div>
    <div style="display: flex; align-items: center;">
      <div style="margin-bottom: 5px; font-size: 16px; line-height: 1.3; text-align: justify;">
...
## Collision Avoidance Algorithm and Motion Planning for Manipulation in Industrial Robots
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
    ...
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research(5).PNG?raw=true" 
      style="max-width: 100%; height: auto; width: 500px; margin-right: 20px; object-fit: contain;" />
    </div>
  </div>
</div>
...
## Optical Fiber Sensor-Based Monitoring for Advanced Manufacturing Processes
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research(6).PNG?raw=true"
           style="max-width: 100%; height: auto; width: 500px; margin-right: 20px; object-fit: contain;" />
    </div>
    <div style="display: flex; align-items: center;">
      <div style="margin-bottom: 5px; font-size: 16px; line-height: 1.3; text-align: justify;">
...
## Additive Manufacturing and Fabrication Research Using Cold Spray Processing
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
    ...
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research(7).PNG?raw=true" 
      style="max-width: 100%; height: auto; width: 500px; margin-right: 20px; object-fit: contain;" />
    </div>
  </div>
</div>
