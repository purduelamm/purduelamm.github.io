...
<!-- section 1 -->
<div style="background-color: #f5f5f5e5; padding: 16px 24px 24px; margin-bottom: 40px;">
<h2 style="margin: 0 0 12px 0; border-bottom: 2px solid #1d1d1dff; padding-bottom: 6px;">
  Smart Manufacturing
</h2>

  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
    <div style="display: flex; align-items: center;">
      <div style="margin-bottom: 5px; font-size: 16px; line-height: 1.3; text-align: justify;">
    ...
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research1_SmartManufacturing.jpg?raw=true" style="max-width: 100%; height: auto; width: 500px; margin-right: 20px; object-fit: contain;" />
    </div>
  </div>
</div>

<!-- section 2 -->
<div style="background-color: #ffffff; padding: 16px 24px 24px; margin-bottom: 40px;">
<h2 style="margin: 0 0 12px 0; border-bottom: 2px solid #1d1d1dff; padding-bottom: 6px;">
  Fiber optic sensor fabrication
</h2>
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research2_FiberOpticSensorFabrication.jpg?raw=true"
           style="max-width: 100%; height: auto; width: 500px; margin-right: 20px; object-fit: contain;" />
    </div>
    <div style="display: flex; align-items: center;">
      <div style="margin-bottom: 5px; font-size: 16px; line-height: 1.3; text-align: justify;">
...
<h2 style="margin: 0 0 12px 0; border-bottom: 2px solid #1d1d1dff; padding-bottom: 6px;">
  ...
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
    ...
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research3_SprayNanoparticleCoatingUsingDecoupledDualVelocityNozzle.jpg?raw=true" 
      style="max-width: 100%; height: auto; width: 500px; margin-right: 20px; object-fit: contain;" />
    </div>
  </div>
</div>
...
<!-- section 4 -->
<div style="background-color: #ffffff; padding: 16px 24px 24px;">
<h2 style="margin: 0 0 12px 0; border-bottom: 2px solid #1d1d1dff; padding-bottom: 6px;">
  Carbon fiber reinforced plastics (CFRP) composite machining
</h2>
  <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
    <div style="display: flex; align-items: center;">
      <img src="https://github.com/purduelamm/purduelamm.github.io/blob/master/assets/images/research/Research4_CarbonFiberReinforcedPlastics(CFRP)CompositeMachining.jpg?raw=true"
           style="max-width: 100%; height: auto; width: 500px; margin-right: 20px; object-fit: contain;" />
    </div>
    <div style="display: flex; align-items: center;">
      <div style="margin-bottom: 5px; font-size: 16px; line-height: 1.3; text-align: justify;">
